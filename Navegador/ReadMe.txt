========================================================================
   APLICACIÓN: Navegador Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Navegador.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Navegador.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Navegador.pch y un archivo de tipos 
